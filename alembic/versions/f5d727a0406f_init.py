...
Revision ID: f5d727a0406f
Revises: 
Create Date: 2025-10-29 19:44:22.590816
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('modified_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['user_rol'], ['users_roles.id_users_roles'], ),
...
def downgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('diagram_id', name=op.f('PK__sysdiagr__C2B05B61EF2ED0E7'))
    )
